                ...
                <div class="overlay">
                    ...
                    <div class="centerBlockContainer with4ButtonsCapsules">
                        <span class="absoluteContent">
                            <img src="<?php echo base_url(); ?>front/images/map.jpg" />
                            <br /> Who is fault?
                        </span>
                    </div>
                    <!--Center Block-->
                    ...
                    <div class="blockClass v_Buttons v_Buttons4Part">
                        <button class="v_ButtonBlockCapsules v_ButtonSuccess">
                            <span class="buttonLabels">A</span>
                            The Green Car
                        </button>
                        <button class="v_ButtonBlockCapsules">
                            <span class="buttonLabels">B</span>
                            Both Cars
                        </button>
                        <button class="v_ButtonBlockCapsules v_ButtonDanger">
        ...
        <div class="blockClass contentWrapper">
            <div class="container">
                ...
                <div class="blockClass labelAndButton">
                    ...
                    <!--Right-->
                    <button onclick="javascript:window.location.href='eight'" class="blockClass fontButton fontButtonInline">Next Questions
