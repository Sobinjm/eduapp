  ...
  <div class="content-wrapper">
    ...
    <section class="content">
		...
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="box box-danger">
				<div class="box-header with-border">
				  <h3 class="box-title">Add new Trainer</h3>
				</div>
				<form id="add_form">
				  <div class="box-body">
					<div class="form-group">
					  <label for="category">Trainer</label>
					  <input type="textbox" class="form-control" id="staff_name" placeholder="Enter Trainer Name">
					</div>
				  
					<div class="form-group">
					  <label for="category">Email</label>
					  <input type="email" class="form-control" id="staff_email" placeholder="Enter Trainer Email">
					</div>
				  
					<div class="form-group">
					  <label for="category">Contact</label>
					  <input type="textbox" class="form-control" id="staff_cnumber" placeholder="Enter Trainer Number">
					</div>
				  ...
				  <div class="box-footer">
					<button type="submit" class="btn btn-danger pull-right">Add Trainer</button>
				  </div>
				</form>
			  </div>
		</div>
		...
		<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">	
			<div class="box box-danger">
				<div class="box-header with-border">
				  <h3 class="box-title">All Trainer Information</h3>
				</div>
