...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url(); ?>admdist/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="<?php echo base_url().'admin/'; ?>"><img style="width:  50%;" src="<?php echo base_url(); ?>/admdist/dist/img/image001.jpg"></img></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
	...
	?>
    <form action="<?php echo base_url(); ?>admin/login/authenticate" id="adm_login" method="post" autocomplete="off">
...
<!-- iCheck -->
<script src="<?php echo base_url(); ?>admdist/plugins/iCheck/icheck.min.js"></script>
<script src="<?php echo base_url(); ?>admdist/dist/js/sweetalert2.all.min.js"></script>
<script src="<?php echo base_url(); ?>admdist/dist/js/jquery.validate.min.js"></script>
<script src="<?php echo base_url(); ?>admdist/dist/js/login.js"></script>
<script>
  $(function () {
    $('input').iCheck({
