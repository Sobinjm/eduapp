		...
		<div class="row" style="margin-top: 10px;">
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">	
				<div class="col-lg-12 col-md-12 col-sm-12 black_bottom">
					...
					<p><?php echo date('d F Y h:m A',strtotime($result[0]['last_login'])); ?></p>
				</div>
			</div> 
		</div>
		<div class="row" style="margin-top: 10px;">
				...
				<table class="table table-striped">
					<tbody>
						...
						<tr>
							...
							<td><i class="fa fa-fw fa-circle" style="color:#6fbe44;"></i> In Progress</td>
							<?php $ddt= date('d-m-Y|h:i:sa',strtotime($mls['created_on'])); 
							$dt=explode('|',$ddt); ?>
							<td><?php echo $dt[0]; ?></td>
							<td><?php echo $dt[1]; ?></td>
