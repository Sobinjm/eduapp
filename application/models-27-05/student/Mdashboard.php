...
class Mdashboard extends CI_Model
	{
	   function __construct()
		...
		function course_info_code($course_id)
		{
			$query = $this->db->query("SELECT * FROM ad_course WHERE course_id = '".$course_id."'");	
			return $query->result_array();
		}
		...
		function getalllessonsbylang_code($course_id,$language)
		{
